...
Autoloader::map(array(
    ...
    'DomainDAO' => path('app').'models/dao/DomainDAO.php',
...
/*
|--------------------------------------------------------------------------
| Timestamps glogal Setting
|--------------------------------------------------------------------------
|
| Activating this option will Set Laravel to assume the existence of a
| created_at and updated_at row in each Table unless stated otherwise.
| It also prevents the assumtion for unknown Tables in case of a
| intermidate Table.
|
*/
